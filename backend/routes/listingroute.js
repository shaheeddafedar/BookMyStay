...
import { addListing, deleListing, findListing, getListing, updateListing } from "../controllers/listingcontroller.js";
...
listingRouter.delete("/delete/:id",isAuth,deleListing
);
